    ...
    <>
      <section className="bg-indigo-50">
        <div className="m-auto py-24 max-w-2xl container">
          <div
            className="bg-white shadow-md m-4 md:m-0 mb-4 px-6 py-8 border rounded-md"
          >
            <form onSubmit={submitForm}>
              <h2 className="mb-6 font-semibold text-3xl text-center">Update Job</h2>
              ...
              <div>
                <button
                  className="bg-indigo-500 hover:bg-indigo-600 px-4 py-2 rounded-full focus:shadow-outline focus:outline-none w-full font-bold text-white"
                  type="submit"
                >
                  Save
                </button>
